...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """login/checkUsernameInUse/""" + "$" + """username<[^/]+>""", """controllers.Application.checkUsernameInUse(username:String)"""),
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """DealItSrv/getAccountType/""" + "$" + """aid<[^/]+>""", """controllers.Application.getAccountType(aid:Integer)"""),
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """DealItSrv/postFeedBack""", """controllers.Application.postFeedBack"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """DealItSrv/setItemToInactive""", """controllers.Application.setItemToInactive"""),
  ...
  // @LINE:23
  private[this] lazy val controllers_Application_checkUsernameInUse9_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("login/checkUsernameInUse/"), DynamicPart("username", """[^/]+""",true)))
  )
  private[this] lazy val controllers_Application_checkUsernameInUse9_invoker = createInvoker(
    Application_1.checkUsernameInUse(fakeValue[String]),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "checkUsernameInUse",
      ...
      "GET",
      """""",
      this.prefix + """login/checkUsernameInUse/""" + "$" + """username<[^/]+>"""
    )
  )

  // @LINE:25
  private[this] lazy val controllers_Application_getUserInfo10_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/user/"), DynamicPart("aid", """[^/]+""",true)))
  )
  private[this] lazy val controllers_Application_getUserInfo10_invoker = createInvoker(
  ...
  // @LINE:26
  private[this] lazy val controllers_Application_getPhoneNumbers11_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_getPhoneNumbers11_invoker = createInvoker(
  ...
  // @LINE:27
  private[this] lazy val controllers_Application_getCreditCard12_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_getCreditCard12_invoker = createInvoker(
  ...
  // @LINE:28
  private[this] lazy val controllers_Application_getProductsFromUser13_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_getProductsFromUser13_invoker = createInvoker(
  ...
  // @LINE:29
  private[this] lazy val controllers_Application_updateCreditCard14_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateCreditCard")))
  )
  private[this] lazy val controllers_Application_updateCreditCard14_invoker = createInvoker(
  ...
  // @LINE:30
  private[this] lazy val controllers_Application_updatePhoneNumber15_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatePhoneNumber")))
  )
  private[this] lazy val controllers_Application_updatePhoneNumber15_invoker = createInvoker(
  ...
  // @LINE:31
  private[this] lazy val controllers_Application_updateUserInfo16_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateUserInfo")))
  )
  private[this] lazy val controllers_Application_updateUserInfo16_invoker = createInvoker(
  ...
  // @LINE:32
  private[this] lazy val controllers_Application_getAccountType17_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/getAccountType/"), DynamicPart("aid", """[^/]+""",true)))
  )
  private[this] lazy val controllers_Application_getAccountType17_invoker = createInvoker(
    Application_1.getAccountType(fakeValue[Integer]),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "getAccountType",
      ...
      "GET",
      """""",
      this.prefix + """DealItSrv/getAccountType/""" + "$" + """aid<[^/]+>"""
    )
  )

  // @LINE:35
  private[this] lazy val controllers_Application_getOrdersFromAccount18_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/order/"), DynamicPart("aid", """[^/]+""",true)))
  )
  private[this] lazy val controllers_Application_getOrdersFromAccount18_invoker = createInvoker(
  ...
  // @LINE:36
  private[this] lazy val controllers_Application_getOrderContent19_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/order/content")))
  )
  private[this] lazy val controllers_Application_getOrderContent19_invoker = createInvoker(
  ...
  // @LINE:37
  private[this] lazy val controllers_Application_insertOrder20_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("insertOrder")))
  )
  private[this] lazy val controllers_Application_insertOrder20_invoker = createInvoker(
  ...
  // @LINE:38
  private[this] lazy val controllers_Application_insertOrderLine21_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("insertOrderLine")))
  )
  private[this] lazy val controllers_Application_insertOrderLine21_invoker = createInvoker(
  ...
  // @LINE:41
  private[this] lazy val controllers_Application_getItemByID22_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/items/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_Application_getItemByID22_invoker = createInvoker(
  ...
  // @LINE:42
  private[this] lazy val controllers_Application_getItemsPerCategory23_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_getItemsPerCategory23_invoker = createInvoker(
  ...
  // @LINE:43
  private[this] lazy val controllers_Application_getProductOwnerInfo24_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_getProductOwnerInfo24_invoker = createInvoker(
  ...
  // @LINE:44
  private[this] lazy val controllers_Application_getFeedbackFromProduct25_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_getFeedbackFromProduct25_invoker = createInvoker(
  ...
  // @LINE:45
  private[this] lazy val controllers_Application_getProductInfo26_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_getProductInfo26_invoker = createInvoker(
  ...
  // @LINE:46
  private[this] lazy val controllers_Application_filterResults27_route = Route("GET",
  ...
  private[this] lazy val controllers_Application_filterResults27_invoker = createInvoker(
  ...
  // @LINE:47
  private[this] lazy val controllers_Application_postFeedBack28_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/postFeedBack")))
  )
  private[this] lazy val controllers_Application_postFeedBack28_invoker = createInvoker(
    Application_1.postFeedBack,
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "postFeedBack",
      ...
      "POST",
      """""",
      this.prefix + """DealItSrv/postFeedBack"""
    )
  )

  // @LINE:48
  private[this] lazy val controllers_Application_setItemToInactive29_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/setItemToInactive")))
  )
  private[this] lazy val controllers_Application_setItemToInactive29_invoker = createInvoker(
    Application_1.setItemToInactive,
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "setItemToInactive",
      ...
      "POST",
      """""",
      this.prefix + """DealItSrv/setItemToInactive"""
    )
  )

  // @LINE:51
  private[this] lazy val controllers_Application_insertNewPost30_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/newPost")))
  )
  private[this] lazy val controllers_Application_insertNewPost30_invoker = createInvoker(
  ...
  // @LINE:54
  private[this] lazy val controllers_Application_getCategoryName31_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("DealItSrv/categories")))
  )
  private[this] lazy val controllers_Application_getCategoryName31_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:23
    case controllers_Application_checkUsernameInUse9_route(params) =>
      call(params.fromPath[String]("username", None)) { (username) =>
        controllers_Application_checkUsernameInUse9_invoker.call(Application_1.checkUsernameInUse(username))
      }
  
    // @LINE:25
    case controllers_Application_getUserInfo10_route(params) =>
      call(params.fromPath[Integer]("aid", None)) { (aid) =>
        controllers_Application_getUserInfo10_invoker.call(Application_1.getUserInfo(aid))
      }
  
    // @LINE:26
    case controllers_Application_getPhoneNumbers11_route(params) =>
      call(params.fromPath[Integer]("uid", None)) { (uid) =>
        controllers_Application_getPhoneNumbers11_invoker.call(Application_1.getPhoneNumbers(uid))
      }
  
    // @LINE:27
    case controllers_Application_getCreditCard12_route(params) =>
      call(params.fromPath[Integer]("aid", None)) { (aid) =>
        controllers_Application_getCreditCard12_invoker.call(Application_1.getCreditCard(aid))
      }
  
    // @LINE:28
    case controllers_Application_getProductsFromUser13_route(params) =>
      call(params.fromPath[Integer]("aid", None)) { (aid) =>
        controllers_Application_getProductsFromUser13_invoker.call(Application_1.getProductsFromUser(aid))
      }
  
    // @LINE:29
    case controllers_Application_updateCreditCard14_route(params) =>
      call { 
        controllers_Application_updateCreditCard14_invoker.call(Application_1.updateCreditCard)
      }
  
    // @LINE:30
    case controllers_Application_updatePhoneNumber15_route(params) =>
      call { 
        controllers_Application_updatePhoneNumber15_invoker.call(Application_1.updatePhoneNumber)
      }
  
    // @LINE:31
    case controllers_Application_updateUserInfo16_route(params) =>
      call { 
        controllers_Application_updateUserInfo16_invoker.call(Application_1.updateUserInfo)
      }
  
    // @LINE:32
    case controllers_Application_getAccountType17_route(params) =>
      call(params.fromPath[Integer]("aid", None)) { (aid) =>
        controllers_Application_getAccountType17_invoker.call(Application_1.getAccountType(aid))
      }
  
    // @LINE:35
    case controllers_Application_getOrdersFromAccount18_route(params) =>
      call(params.fromPath[Integer]("aid", None)) { (aid) =>
        controllers_Application_getOrdersFromAccount18_invoker.call(Application_1.getOrdersFromAccount(aid))
      }
  
    // @LINE:36
    case controllers_Application_getOrderContent19_route(params) =>
      call { 
        controllers_Application_getOrderContent19_invoker.call(Application_1.getOrderContent)
      }
  
    // @LINE:37
    case controllers_Application_insertOrder20_route(params) =>
      call { 
        controllers_Application_insertOrder20_invoker.call(Application_1.insertOrder)
      }
  
    // @LINE:38
    case controllers_Application_insertOrderLine21_route(params) =>
      call { 
        controllers_Application_insertOrderLine21_invoker.call(Application_1.insertOrderLine)
      }
  
    // @LINE:41
    case controllers_Application_getItemByID22_route(params) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_Application_getItemByID22_invoker.call(Application_1.getItemByID(id))
      }
  
    // @LINE:42
    case controllers_Application_getItemsPerCategory23_route(params) =>
      call(params.fromPath[String]("category", None)) { (category) =>
        controllers_Application_getItemsPerCategory23_invoker.call(Application_1.getItemsPerCategory(category))
      }
  
    // @LINE:43
    case controllers_Application_getProductOwnerInfo24_route(params) =>
      call(params.fromPath[Integer]("pid", None)) { (pid) =>
        controllers_Application_getProductOwnerInfo24_invoker.call(Application_1.getProductOwnerInfo(pid))
      }
  
    // @LINE:44
    case controllers_Application_getFeedbackFromProduct25_route(params) =>
      call(params.fromPath[Integer]("pid", None)) { (pid) =>
        controllers_Application_getFeedbackFromProduct25_invoker.call(Application_1.getFeedbackFromProduct(pid))
      }
  
    // @LINE:45
    case controllers_Application_getProductInfo26_route(params) =>
      call(params.fromPath[Integer]("pid", None)) { (pid) =>
        controllers_Application_getProductInfo26_invoker.call(Application_1.getProductInfo(pid))
      }
  
    // @LINE:46
    case controllers_Application_filterResults27_route(params) =>
      call(params.fromPath[String]("filter", None), params.fromPath[String]("category", None)) { (filter, category) =>
        controllers_Application_filterResults27_invoker.call(Application_1.filterResults(filter, category))
      }
  
    // @LINE:47
    case controllers_Application_postFeedBack28_route(params) =>
      call { 
        controllers_Application_postFeedBack28_invoker.call(Application_1.postFeedBack)
      }
  
    // @LINE:48
    case controllers_Application_setItemToInactive29_route(params) =>
      call { 
        controllers_Application_setItemToInactive29_invoker.call(Application_1.setItemToInactive)
      }
  
    // @LINE:51
    case controllers_Application_insertNewPost30_route(params) =>
      call { 
        controllers_Application_insertNewPost30_invoker.call(Application_1.insertNewPost)
      }
  
    // @LINE:54
    case controllers_Application_getCategoryName31_route(params) =>
      call { 
        controllers_Application_getCategoryName31_invoker.call(Application_1.getCategoryName)
      }
    ...
    case controllers_Assets_at55_route(params) =>
      call(Param[String]("path", Right("/public/html/templates")), Param[String]("file", Right("addPost.html"))) { (path, file) =>
        controllers_Assets_at55_invoker.call(Assets_0.at(path, file))
      }
    ...
    case controllers_Assets_at56_route(params) =>
      call(Param[String]("path", Right("/public/html/templates")), Param[String]("file", Right("cart.html"))) { (path, file) =>
        controllers_Assets_at56_invoker.call(Assets_0.at(path, file))
      }
    ...
    case controllers_Assets_at57_route(params) =>
      call(Param[String]("path", Right("/public/html/templates")), Param[String]("file", Right("checkout.html"))) { (path, file) =>
        controllers_Assets_at57_invoker.call(Assets_0.at(path, file))
      }
    ...
    case controllers_Assets_at58_route(params) =>
      call(Param[String]("path", Right("/public/html/templates")), Param[String]("file", Right("order_success.html"))) { (path, file) =>
        controllers_Assets_at58_invoker.call(Assets_0.at(path, file))
      }
  }
}
