...
package controllers {
  ...
  class ReverseApplication(_prefix: => String) {
    ...
    // @LINE:48
    def setItemToInactive(): Call = {
      import ReverseRouteContext.empty
      Call("POST", _prefix + { _defaultPrefix } + "DealItSrv/setItemToInactive")
    }
    ...
    // @LINE:47
    def postFeedBack(): Call = {
      import ReverseRouteContext.empty
      Call("POST", _prefix + { _defaultPrefix } + "DealItSrv/postFeedBack")
    }
    ...
    // @LINE:32
    def getAccountType(aid:Integer): Call = {
      import ReverseRouteContext.empty
      Call("GET", _prefix + { _defaultPrefix } + "DealItSrv/getAccountType/" + implicitly[PathBindable[Integer]].unbind("aid", aid))
    }
